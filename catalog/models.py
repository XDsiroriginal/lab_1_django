...
class Book(models.Model):
    ...
    isbn = models.CharField('ISBN',max_length=13, help_text='13 Характеров <a href="https://www.isbn-international.org/content/what-isbn">ISBN число</a>')
...
class BookInstance(models.Model):
    ...
    class Meta:
        ordering = ["due_back"]
        permissions = (("can_view_all_borrowers", "Can view all borrowers"),)
